 ...
 * @version Final 1.5
 */
@WebServlet(name = "GameWonServlet", urlPatterns = {"/GameWonServlet"})
public class GameWonServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Cookie cookie = new Cookie("lastStatus", "won");
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Congratulations! You win!</h1>");
            out.println("<br>");
            out.println("<br>");
            if (score != -1) {
